...
const services = [
  {
    ...
    desc: 'We handle customs documentation, regulatory approvals, duty processing, and cargo clearance to ensure smooth import and export operations.',
    color: 'from-blue-500 to-blue-700',
  },
  {
    icon: Ship,
    title: 'Freight Forwarding',
    desc: 'We coordinate transportation of cargo through sea, air, and road using trusted logistics partners.',
    color: 'from-[#A77428] to-[#d4a853]',
  },
  {
    icon: Package,
    title: 'Shipping',
    desc: 'Reliable cargo booking, tracking, container shipping (FCL/LCL), and port logistics services worldwide.',
    color: 'from-emerald-500 to-emerald-700',
  },
  {
    icon: Warehouse,
    title: 'Warehousing',
    desc: 'Safe storage and inventory management solutions.',
    color: 'from-violet-500 to-violet-700',
  },
  {
    icon: Truck,
    title: 'Transportation',
    desc: 'Reliable movement of cargo between ports, warehouses, and customer locations.',
    color: 'from-orange-500 to-orange-700',
  },
  {
    icon: Globe2,
    title: 'Import & Export Consultancy',
    desc: 'Professional guidance on customs regulations, documentation, and international trade.',
    color: 'from-cyan-500 to-cyan-700',
  },
  {
    icon: FileText,
    title: 'Documentation Assistance',
    desc: 'Preparation and verification of shipping and customs documents.',
